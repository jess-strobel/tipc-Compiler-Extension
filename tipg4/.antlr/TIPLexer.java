...
public class TIPLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "BOOL", "MUL", "DIV", "ADD", "SUB", "MOD", "GT", "GTE", 
			"LT", "LTE", "EQ", "NE", "NOT", "AND", "OR", "NUMBER", "KALLOC", "KINPUT", 
			"KWHILE", "KFOR", "KIF", "KELSE", "KVAR", "KRETURN", "KNULL", "KOUTPUT", 
			"KERROR", "KTRUE", "KFALSE", "KPOLY", "IDENTIFIER", "WS", "BLOCKCOMMENT", 
			"COMMENT"
		};
	}
